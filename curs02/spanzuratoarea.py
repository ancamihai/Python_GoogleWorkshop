...
# dc litera de inceput si litera de sfarsit se gasesc in interiorul cuvantului, litera trebuie sa fie vizibila
...
# verificat: sa nu fie cifra => string.isdigit(), sa nu fie mai mult de 1 caracter => len(string) > 1, sa nu fie spatiu
...
#  cuvant[index] = litera_de_incercat
    if numar_incercari == 7:
        print(f"Ai pierdut. Cuvantul intial era: {cuvant_de_ghicit}")
